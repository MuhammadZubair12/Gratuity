# from erpnext.hrms.payroll.doctype.gratuity import Gratuity
# from erpnext.payroll.doctype.gratuity import Gratuity
...
class GratuityControll(AccountsController):
	def validate(self):
